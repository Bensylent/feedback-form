...
@Component({
  selector: 'app-root',
  templateUrl: '../layout/feedback.component.html',
  styleUrls: ['../layout/feedback.component.scss']
})
export class AppComponent implements OnInit{
  ...
  categories = [ 
    ...
    {name :"Core KPI Reviews", id: 5},
    {name :"Paynow Merchant TCR", id: 6},
    {name :"Retention", id: 7},
    {name :"Revenue", id: 8},
    {name :"Foreign Currency Transactions", id: 9},
    {name :"Currency By Category", id: 10},
    {name :"Transactions By Voucher Type", id: 11}
